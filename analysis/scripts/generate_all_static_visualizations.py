...
OUTPUT_DIR = BASE_DIR / 'FINAL_DELIVERABLES_2_backup_20251125_194954 copy 2/visualizations/static'
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

# Import IWRC branding
try:
    from iwrc_brand_style import IWRC_COLORS, configure_matplotlib_iwrc, add_logo_to_matplotlib_figure
...
# Color scheme
# Color scheme - Mapped to IWRC Palette
COLORS = {
    'blue': IWRC_COLORS['primary'],      # Teal
    'orange': IWRC_COLORS['accent'],     # Peach
    'green': IWRC_COLORS['secondary'],   # Olive
    'red': IWRC_COLORS['gold'],          # Gold
    'purple': '#9467bd',
    'brown': '#8c564b',
    'pink': '#e377c2',
    'gray': IWRC_COLORS['text'],
    'olive': IWRC_COLORS['secondary'],
    'cyan': '#17becf'
}

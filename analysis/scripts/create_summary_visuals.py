...
try:
    ...
    print("Warning: IWRC branding not available, using defaults")
    USE_IWRC = False
    plt.rcParams['font.family'] = 'sans-serif'

# IWRC Colors (fallback to UIUC if not available)
if USE_IWRC:
    UIUC_BLUE = IWRC_COLORS['dark_teal']
    UIUC_ORANGE = IWRC_COLORS['accent']
    SUCCESS_GREEN = IWRC_COLORS['secondary']
    WARNING_YELLOW = IWRC_COLORS['gold']
    LIGHT_GRAY = IWRC_COLORS['background']
    DARK_GRAY = IWRC_COLORS['text']
else:
    UIUC_BLUE = '#13294B'
    UIUC_ORANGE = '#FF5F05'

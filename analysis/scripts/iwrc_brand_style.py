...
def add_logo_to_matplotlib_figure(fig, position='top-right', size=0.08):
    ...
    """
    # Logo addition disabled per user request (removing circles)
    return
    ...
    try:
        ...
        # Calculate zoom factor based on figure height
        # size is fraction of figure height
        fig_width, fig_height = fig.get_size_inches()
        fig_dpi = fig.get_dpi()
        
        target_height = fig_height * fig_dpi * size

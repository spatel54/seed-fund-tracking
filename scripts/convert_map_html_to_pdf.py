...
def convert_html_to_pdf_with_playwright():
    ...
    html_file = Path('/Users/shivpat/Downloads/Seed Fund Tracking/visualizations/interactive/institutional_distribution_map.html')
    pdf_file = Path('/Users/shivpat/Downloads/Seed Fund Tracking/visualizations/pdfs/2025_illinois_institutions_map.pdf')
...
def generate_simple_plotly_pdf():
    ...
    # Try to save as PDF
    pdf_path = Path('/Users/shivpat/Downloads/Seed Fund Tracking/visualizations/pdfs/2025_illinois_institutions_map.pdf')

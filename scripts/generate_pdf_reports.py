...
def generate_roi_analysis_pdf(df_10yr, df_5yr, metrics_10yr, metrics_5yr):
    ...
    with PdfPages(pdf_path) as pdf:
        ...
        ax.text(0.5, 0.78, 'Return on Investment Analysis', ha='center', fontsize=28, color='#1f77b4', transform=ax.transAxes)
...
def generate_seed_fund_analysis_pdf(df_10yr, df_5yr, metrics_10yr, metrics_5yr):
    ...
    with PdfPages(pdf_path) as pdf:
        ...
        ax.text(0.5, 0.82, 'Tracking Analysis Report', ha='center', fontsize=24, color='#ff7f0e', transform=ax.transAxes)
